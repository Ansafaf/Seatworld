...
export const getBestOffer = (product, activeOffers) => {
    ...
    // If product has both category and product offers, select the one with highest discount percentage
    // This ensures the customer gets the best deal when multiple offers apply
