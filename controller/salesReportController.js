...
export const getSalesReport = async (req, res) => {
    try {
        ...
        res.status(status_Codes.INTERNAL_SERVER_ERROR).render("500", { message: "Failed to load sales report" });
    }
}
...
export const getDownloadSales = async (req, res) => {
    try {
        ...
        res.status(status_Codes.INTERNAL_SERVER_ERROR).json({ message: "PDF generation failed" });
    }
};
...
export const getDownloadExcel = async (req, res) => {
    try {
        ...
        res.status(status_Codes.INTERNAL_SERVER_ERROR).json({ message: "Excel generation failed" });
    }
};